...
module.exports = function poxyColumnDecl(css, settings) {
  css.walkDecls('poxy-x', function(decl) {
    var declArr = [],
        poxyColumn,
        copy_width,
        gutter_x,
    ...
    decl.cloneBefore({
      prop: 'width',
      value: 'calc('+ copy_width +' * '+ poxyColumn +' - ('+ gutter_x +'vw - '+ gutter_x +'vw * '+ poxyColumn +'))'
    });
